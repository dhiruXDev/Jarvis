...
import startSound from './Analysing/assets/audio/start_sound.mp3';

export default function AnalysingLoader({ onFinished }) {
  ...
  useEffect(() => {
    ...
    const statuses = [
      ...
      'Calibrating Quantum Vectors...',
      'Establishing SSE Link...',
      'System Secure. Launching JARVIS...'
    ];
  ...
  return (
    <div className={`fixed inset-0 z-[9999] bg-black flex flex-col justify-center items-center select-none transition-opacity duration-500 ${isFading ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
      ...
      {/* Sci-fi Loader Body */}
      <div className="svg-frame mb-8 scale-90 md:scale-100">
        
        {/* base (i: 0) */}
        <svg style={{ '--i': 0 }} viewBox="0 0 450 450">
          <g id="big-outter">
            <g id="squares">
              <path
                id="Ellipse 25"
        ...
        {/* big centro (i: 1) */}
        <svg style={{ '--i': 1 }} viewBox="0 0 450 450">
          <g id="big-centro">
        ...
        {/* solo lines (i: 2) */}
        <svg style={{ '--i': 2 }} viewBox="0 0 450 450">
          <g id="solo-lines">
            <g id="left-line">
        ...
        {/* outter center (i: 3) */}
        <svg style={{ '--i': 3 }} viewBox="0 0 450 450">
          <g id="outter-center">
            <g id="Ellipse 33">
        ...
        {/* center lines (i: 4) */}
        <svg style={{ '--i': 4 }} viewBox="0 0 450 450">
          <g id="center-lines">
        ...
        {/* center (i: 5) */}
        <svg style={{ '--i': 5 }} viewBox="0 0 450 450">
          <g id="center">
            <path
              id="center_2"
      ...
      {/* Sci-fi Terminal/Wish Message */}
      <div className="flex flex-col items-center">
        <h1 className="font-hud text-cyber-blue tracking-[4px] text-lg uppercase animate-pulse">
          {statusText}
        </h1>
        <div className="w-[200px] h-[2px] bg-gradient-to-r from-transparent via-cyber-blue to-transparent mt-2 shadow-[0_0_8px_#00bbff]"></div>
      </div>
